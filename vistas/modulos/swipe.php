<div class="contenedorSwipe">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 imgSwipe" src="vistas/img/usuarios/16/16-1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 imgSwipe" src="vistas/img/usuarios/16/16-3.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 imgSwipe" src="vistas/img/usuarios/16/16-4.jpg" alt="Third slide">
    </div>
  </div>
